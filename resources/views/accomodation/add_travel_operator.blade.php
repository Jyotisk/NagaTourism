            ...
            <div class='container'>
                <div class='card'>
                    <div class='card-header'>
                        <h3>Add Travel Operator</h3>
                    </div>
                    <div class='card-body'>
                        <form id="add_TravelOperator">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(document).on("submit", "#add_TravelOperator", function(e) {
        e.preventDefault();
        $.ajax({
            type: "POST",
            url: "{{route('AddTravelOperator')}}",
            headers: {
            ...
            if (data.message == 'success') {
                Swal.fire({
                        title: "Success",
                        text: "TravelOperator data has been saved successfully",
                        icon: "success",
                        buttons: true,
                        dangerMode: true,
                    })

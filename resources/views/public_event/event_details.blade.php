                ...
                <div class="col-12 col-lg-8 order-last order-lg-first body-fix">
                    <div class="dest-card card mb-4">
                        <div class="card-header">
                            <img class="destination-pic" src="{{ url('storage/'."$events->event_image_main") }}" alt="Destination Picture">
                        </div>
                        <div class="card-body mt-5">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <p class="date-text">
                                    ...
                                    {{$events->month}} {{$events->day}}, {{$events->year}}

                                </p>
                            </div>
                            @if(isset($events->event_description))
                            @php
                            $text = trim($events->event_description);
                            $textAr = explode("\n", $text);
                            ...
                            @endforeach
                            @endif
                            @if($events->add_activity_status==1)
                            <h4>Activities</h4>
                            @foreach($event_activity AS $activity)
                            <p class="fw-3">{{$loop->iteration}}. {{$activity->event_activity}}</p>
                            @endforeach
                            @endif
                        </div>
                    </div>
